...
program_H = e[['BARCD_IND', 'REGION_CODE_CONTINENT', 'DESCRIPTION',
               ...
               'periodo_f1', 'semana_A', 'semana_B', 'DELTA_1']]

"""
column_III = ['REGION_CODE_CONTINENT', 'DESCRIPTION',
...
program_H['DELTA_1'].describe()
program_H['DELTA_1_est'].describe()

program_H['DELTA_1'].hist()
program_H['DELTA_1_est'].hist()
...
boxplot = program_H.boxplot(column=['DELTA_1', 'DELTA_1_est'])
boxplot.plot()
plt.show()
